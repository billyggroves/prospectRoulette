        ...
        if proComp != None:
            ...
            if len(companies) <= 10:
                ...
                for comp in proComp:
                    ...
                    phone = comp.phone
                    message = Messages.query.filter_by(comp_id=comp.comp_id).order_by(desc(Messages.timeInserted))
...
def prospects():
    ...
    if request.method == "GET":
        ...
        for comp in companies:
            ...
            phone = comp.phone
            messId = 0
            messages = Messages.query.filter_by(comp_id=comp.comp_id).order_by(desc(Messages.timeInserted))
...
def asyncInsert():
    ...
    if request.method == "GET":
        ...
        inMess = Messages(None, comp.comp_id, companyData[8], finalStamp)
        ...
        # If contact info was provided then insert the company's contact info
            ...
            inCont = Contacts(None, comp.comp_id, contactData[0], contactData[1], contactData[2], contactData[3])
